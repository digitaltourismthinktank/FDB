      ...
      <section style={{ maxWidth: 1000, margin: '0 auto', padding: '5rem 3rem 4.5rem', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'end' }}>
        <div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1.75rem' }}>
            <img src={dark ? window.__resources.xAwardsWordmarkDark : window.__resources.xAwardsWordmark} alt="X. Awards" style={{ height: 72, width: 'auto', display: 'block' }}/>
          </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
          <img src={dark ? window.__resources.xAwardsWordmarkDark : window.__resources.xAwardsMark} alt="X. Awards" style={{ width: dark ? 320 : 200, height: 'auto', display: 'block' }}/>
        </div>
      </section>
