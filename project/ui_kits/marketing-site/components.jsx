    ...
    <header style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '1.25rem' }}>
        <button onClick={() => onNav?.('/')} style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 0, display: 'block' }}>
          <img src={dark ? "../../assets/logos/dark/fdb-banner-dark.png" : "../../assets/logos/fdb-banner.png"} alt="Future Destination Brand." style={{ height: 38, width: 'auto', display: 'block' }}/>
        </button>
        <span style={{
...
function Footer({ dark = false }) {
  return (
    <footer style={{
      ...
      flexWrap: 'wrap', gap: '1.25rem 2rem',
    }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
        <img src={dark ? "../../assets/logos/dark/fdb-banner-dark.png" : "../../assets/logos/fdb-banner.png"} alt="Future Destination Brand." style={{ height: 24, width: 'auto', display: 'block' }}/>
...
function HostPartner({ dark = false, label = 'Host partner' }) {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: '0.7rem' }}>
      ...
      <span style={{
        ...
        <img src="../../assets/logos/failte-ireland.png" alt="Fáilte Ireland" style={{ height: 22, width: 'auto', display: 'block' }}/>
      </span>
    </div>
  );
}
...
Object.assign(window, {
  ...
  Header, Footer, DarkToggle, HostPartner,
