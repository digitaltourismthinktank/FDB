      ...
      <section className="fdb-wrap" style={{ paddingTop: '4rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2.5rem 2rem' }}>
          {[
            ...
            { h: 'Year-round value.', b: 'The Future Destination Trends 2027 report gives destination teams a structured foundation for planning the year ahead. Working groups continue quarterly through 2027, translating the conversations from Dublin into sustained actions and value well into the year.' },
          ].map((p, i) => (
